...
def generate_board():
    ...
    absolute_barrel_location = relative_barrel_location[0] + turret_x, relative_barrel_location[1] + turret_y
    plt.plot([turret_x, absolute_barrel_location[0]], [turret_y, absolute_barrel_location[1]], c="b")
    ...
    rocket_front_location = rocket_x + relative_rocket_end[0], rocket_y + relative_rocket_end[1]
    rocket_rear_location = rocket_x - relative_rocket_end[0], rocket_y - relative_rocket_end[1]
    plt.plot([rocket_front_location[0], rocket_rear_location[0]], [rocket_front_location[1], rocket_rear_location[1]], c="g")
    thruster_width = 2.0
    ...
    thruster_left_location = rocket_rear_location[0] + relative_thruster_end[0], rocket_rear_location[1] + relative_thruster_end[1]
    thruster_right_location = rocket_rear_location[0] - relative_thruster_end[0], rocket_rear_location[1] - relative_thruster_end[1]
    plt.plot([thruster_left_location[0], thruster_right_location[0]], [thruster_left_location[1], thruster_right_location[1]], c="g")
